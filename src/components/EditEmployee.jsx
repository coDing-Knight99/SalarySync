...
const EditEmployee = ({seteditEmployee,e}) => {
          ...
          <div onClick={() => {
            ...
            document.body.classList.remove("overflow-hidden")
              ...
              <div className='w-[40%] h-[70%] flex flex-col bg-white rounded-2xl' onClick={(e) => { e.stopPropagation() }}>
                {console.log(e)}
                  <div className='text-center p-5 text-2xl font-bold'>Edit Employee</div>
                  <div className='flex flex-col gap-5'>
                     ...
                     focus:border-blue-500 transition-all" defaultValue={e.name} placeholder='Enter Employee Name...' type="text" />
                      </div>
                      <div className='px-5'>
                          <label className='text-xl font-medium'>Email</label>
                          <input className="w-full my-2 pl-3 pr-4 py-2 bg-white border border-gray-300 rounded-xl 
                     focus:outline-none focus:ring-2 focus:ring-blue-500 
                     focus:border-blue-500 transition-all" placeholder='Enter Employee email...' type="text" defaultValue={e.email} />
                      </div>
                     ...
                     focus:outline-none focus:ring-2 focus:ring-blue-500 
                     focus:border-blue-500 transition-all'defaultValue={e.salary}/>
                          </div>
                          <div className='w-[50%] px-5'>
                     ...
                     focus:border-blue-500 transition-all' placeholder='Enter Overtime Rate (Rupees/hour)...'/>
                      ...
                      <div className='w-full flex items-center justify-end gap-3'>
                          <div onClick={()=>{seteditEmployee(null)}} className=' border py-3 px-2 rounded-2xl cursor-pointer hover:shadow-2xl'>Cancel</div>
